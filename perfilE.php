...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5"> 
        ...
        <div class="navbar-nav mr-auto py-0">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item nav-link active"><a class="nav-link" href="indexE.php">EVENTOS</a></li>
                <li class="nav-item nav-link active"><a class="nav-link" href="historialE.php">HISTORIAL</a></li>
                ...
                <li><a href="perfilE.php" class="nav-item nav-link"><img src="<?php echo $fotoPerfil ?>" class="size2"></a></li>
            </ul>
        </div>
    ...
    <div class="profile-container">
        ...
        <form action="perfilE.php" method="post" enctype="multipart/form-data">
